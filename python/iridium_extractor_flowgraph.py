...
class FlowGraph(gr.top_block):
    def __init__(self, center_frequency, sample_rate, decimation, filename, sample_format=None, threshold=7.0,
                 ...
                 raw_capture_filename=None, debug_id=None, debug_time=-1, max_bursts=0, verbose=False, file_info="",
        ...
        if self._use_channelizer:
            ...
            for channel in range(self._channels):
                ...
                if debug_time >=0:
                    burst_downmixer.debug_time(debug_time)
            ...
            if debug_time >= 0:
                burst_downmix.debug_time(debug_time)
